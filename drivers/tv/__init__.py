...
The 'TV' class is also defined here and represents the actual device itself. TV
instance variables include its interface (TVInterface), model number, and list of
